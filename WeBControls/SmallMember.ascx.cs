...
public partial class WeBControls_SmallMember : System.Web.UI.UserControl
{
    string strTemp;
    bool IsBookMark;
    bool IsRemove;
    ...
    public void Bind(string MatrimonialID, bool ISBookMark, bool ISRemove)
    {
        ...
        using (SqlConnection objConnection = DBConnection.GetSqlConnection())
        {
            ...
            try
            {
                ...
                L_Religion.Text = ControlDataLoader.GetIndexValue(ControlDataLoader.ControlType.Religion, Convert.ToSByte(objReader["Religion"])) + " <br/> " + ControlDataLoader.GetIndexValue(ControlDataLoader.ControlType.Cast, Convert.ToSByte(objReader["Cast"]));
    ...
    public bool Bind(string MatrimonialID)
    {
        ...
        using (SqlConnection objConnection = DBConnection.GetSqlConnection())
        {
            ...
            //{
                ...
                HL_ViewProfile.NavigateUrl = "~/Member/PrintProfile.aspx?matid=" + Server.UrlEncode(Crypto.EnCrypto(MatrimonialID));
