<%@ Page Language="C#" MasterPageFile="~/Admin/Protected/Admin.master" AutoEventWireup="true" CodeFile="CheckMembers.aspx.cs" Inherits="Admin_Protected_CheckMembers" Title="Remove Member" %>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="HeadText1" colspan="4" style="text-align: left" valign="top">
                    <!-- Pannel Delete-->
                    <asp:Panel ID="PN_Delete" runat="server" Height="100%" Visible="False" Width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 24%; height: 22px; text-align: right">
                                        &nbsp;</td>
                                    <td style="width: 85%; height: 22px">
                                        <asp:Button ID="Button1" runat="server" CssClass="green-button"
                                            Text="Search" Width="61px" />
                                        <asp:Label ID="L_Wron_Pass" runat="server" ForeColor="Red" Text="Password Entred Is Wrong"
                                            Visible="False"></asp:Label><span style="color: #ff0000"></span></td>
                                </tr>
                                <tr>
                    ...
                    <asp:Panel ID="PN_CheckAnon" runat="server" Height="100%" Visible="False" Width="100%">
                        <table align="left" border="0" cellpadding="2" cellspacing="1" width="100%">
                            <tbody>
                                <tr>
                                    <td class="Partext1" style="width: 38px; height: 19px">
                                        <strong class="paratext"><span class="paratext" style="color: #000000"></span></strong>
                                    </td>
                                    <td style="width: 502px; color: #000000; height: 19px; text-align: justify" colspan="2">
                                ...
                                <td style="width: 53px"></td>
                                    <td class="Partext1">
                                        <asp:Table ID="Table_View" runat="server" CaptionAlign="Top" CellPadding="1" CellSpacing="0"
                                            GridLines="Horizontal" Width="98%">
                                            <asp:TableRow ID="TableRow1" runat="server" BackColor="#8CD3EF">
                                                <asp:TableCell ID="TableCell5" runat="server" HorizontalAlign="Left" Text="MatrimonialID"
                                                    VerticalAlign="Middle" Width="30%"></asp:TableCell>
                                                <asp:TableCell runat="server" Width="60%">Message</asp:TableCell>
                                                <asp:TableCell runat="server" Width="10%">Delete</asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </td>
                                </tr>
