<%@ Page Language="C#" MasterPageFile="~/Member/MemberMaster.master" Title="No Records Found" %>
                                    ...
                                    <td>
                                        <table border="0" class="afterloglightyellow1" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td bgcolor="#dbdbdb" colspan="2" height="20">
                                                        <strong><a class="bodylink" href="Occ_Search.aspx">Occupational Search </a></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td bgcolor="#f0f0f0" width="25%">
