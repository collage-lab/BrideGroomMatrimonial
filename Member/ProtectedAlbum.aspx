<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProtectedAlbum.aspx.cs" Inherits="Member_ProtectedAlbum" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title runat = "server">View Image</title>
        ...
        <table width="100%" border="0" class="submenubox" height="100%">
            ...
            <tr>
                ...
                <td style="width: 60%; text-align: center;">
                    <asp:Image ID="Img_image" runat="server" /><br />
                </td>
                <td style="width: 20%">
                </td>
            </tr>
